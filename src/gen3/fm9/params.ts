...
export const FM9_PARAMS: readonly Param[] = [
  ...
  { family: 'CROSSOVER', paramId: 2, name: 'CROSSOVER_LOWGAINL', displayLabel: 'Low Level Left', unit: 'db' }, // unit from typecode class 0x1
  { family: 'CROSSOVER', paramId: 3, name: 'CROSSOVER_HIGAINL', displayLabel: 'Hi level Left', unit: 'db' }, // unit from typecode class 0x1
  { family: 'CROSSOVER', paramId: 4, name: 'CROSSOVER_LOWGAINR', displayLabel: 'Low Level Right', unit: 'db' }, // unit from typecode class 0x1
  { family: 'CROSSOVER', paramId: 5, name: 'CROSSOVER_HIGAINR', displayLabel: 'Hi Level Right', unit: 'db' }, // unit from typecode class 0x1
  ...
  { family: 'CROSSOVER', paramId: 11, name: 'CROSSOVER_LEVEL', displayLabel: 'Level', unit: 'db' }, // unit from typecode class 0x1
  ...
  { family: 'DELAY', paramId: 13, name: 'DELAY_RATIO', displayLabel: 'L/R Time Ratio', unit: 'percent' }, // unit from typecode class 0x5; device-true 13 (III 3 would mis-address)
  { family: 'DELAY', paramId: 14, name: 'DELAY_FEED', displayLabel: 'Feedback', unit: 'percent' }, // unit from typecode class 0x5; device-true 14 (III 4 would mis-address)
  { family: 'DELAY', paramId: 15, name: 'DELAY_FEEDL', unit: 'percent' }, // device-true 15 (III 5 would mis-address) // unit from typecode class 0x5
  { family: 'DELAY', paramId: 16, name: 'DELAY_FEEDR', displayLabel: 'Feedback R', unit: 'percent' }, // unit from typecode class 0x5; device-true 16 (III 6 would mis-address)
  ...
  { family: 'DELAY', paramId: 18, name: 'DELAY_SPREAD', displayLabel: 'Spread', unit: 'percent' }, // unit from typecode class 0x5; device-true 18 (III 8 would mis-address)
  ...
  { family: 'DELAY', paramId: 22, name: 'DELAY_RATE1', displayLabel: 'Rate', unit: 'hz' }, // unit from typecode class 0x2; device-true 22 (III 12 would mis-address)
  { family: 'DELAY', paramId: 23, name: 'DELAY_RATE2', displayLabel: 'Rate', unit: 'hz' }, // unit from typecode class 0x2; device-true 23 (III 13 would mis-address)
  { family: 'DELAY', paramId: 24, name: 'DELAY_DEPTH1', displayLabel: 'Depth', unit: 'percent' }, // unit from typecode class 0x5; device-true 24 (III 14 would mis-address)
  { family: 'DELAY', paramId: 25, name: 'DELAY_DEPTH2', displayLabel: 'Depth', unit: 'percent' }, // unit from typecode class 0x5; device-true 25 (III 15 would mis-address)
  ...
  { family: 'DELAY', paramId: 27, name: 'DELAY_GAIN', displayLabel: 'Input Gain', unit: 'percent' }, // unit from typecode class 0x5; device-true 27 (III 23 would mis-address)
  ...
  { family: 'DELAY', paramId: 30, name: 'DELAY_TIMER', displayLabel: 'Time R', unit: 'ms' }, // unit from typecode class 0x4; device-true 30 (III 26 would mis-address)
  ...
  { family: 'DELAY', paramId: 34, name: 'DELAY_FEEDLR', displayLabel: 'Rotation', unit: 'percent' }, // unit from typecode class 0x5; device-true 34 (III 30 would mis-address)
  { family: 'DELAY', paramId: 35, name: 'DELAY_FEEDRL', unit: 'percent' }, // device-true 35 (III 31 would mis-address) // unit from typecode class 0x5
  ...
  { family: 'DELAY', paramId: 40, name: 'DELAY_LFO1PHASE', displayLabel: 'Phase', unit: 'degrees' }, // unit from typecode class 0x6; device-true 40 (III 36 would mis-address)
  { family: 'DELAY', paramId: 41, name: 'DELAY_LFO2PHASE', displayLabel: 'Phase', unit: 'degrees' }, // unit from typecode class 0x6; device-true 41 (III 37 would mis-address)
  { family: 'DELAY', paramId: 42, name: 'DELAY_SPLICETIME', displayLabel: 'Crossfade Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 42 (III 38 would mis-address)
  ...
  { family: 'DELAY', paramId: 46, name: 'DELAY_ATTEN', displayLabel: 'Attenuation', unit: 'db' }, // unit from typecode class 0x1; device-true 46 (III 42 would mis-address)
  { family: 'DELAY', paramId: 47, name: 'DELAY_THRESH', displayLabel: 'Threshold', unit: 'db' }, // unit from typecode class 0x1; device-true 47 (III 43 would mis-address)
  { family: 'DELAY', paramId: 48, name: 'DELAY_RELEASE', displayLabel: 'Release Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 48 (III 44 would mis-address)
  { family: 'DELAY', paramId: 49, name: 'DELAY_DIFFUSE', displayLabel: 'Diffusion', unit: 'percent' }, // unit from typecode class 0x5; device-true 49 (III 45 would mis-address)
  { family: 'DELAY', paramId: 50, name: 'DELAY_DIFFTIME', displayLabel: 'Diffusion Time', unit: 'percent' }, // unit from typecode class 0x5; device-true 50 (III 46 would mis-address)
  ...
  { family: 'DELAY', paramId: 56, name: 'DELAY_RATE3', displayLabel: 'Sweep Rate', unit: 'hz' }, // unit from typecode class 0x2; device-true 56 (III 52 would mis-address)
  ...
  { family: 'DELAY', paramId: 58, name: 'DELAY_LFO3PHASE', displayLabel: 'Sweep Phase', unit: 'degrees' }, // unit from typecode class 0x6; device-true 58 (III 54 would mis-address)
  ...
  { family: 'DELAY', paramId: 60, name: 'DELAY_FSTART', displayLabel: 'Start Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 60 (III 56 would mis-address)
  { family: 'DELAY', paramId: 61, name: 'DELAY_FSTOP', displayLabel: 'Stop Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 61 (III 57 would mis-address)
  ...
  { family: 'DELAY', paramId: 65, name: 'DELAY_FREQ1', displayLabel: 'Freq 1', unit: 'hz' }, // unit from typecode class 0x2; device-true 65 (III 61 would mis-address)
  { family: 'DELAY', paramId: 66, name: 'DELAY_FREQ2', displayLabel: 'Freq 2', unit: 'hz' }, // unit from typecode class 0x2; device-true 66 (III 62 would mis-address)
  ...
  { family: 'DELAY', paramId: 69, name: 'DELAY_GAIN1', displayLabel: 'Gain 1', unit: 'db' }, // unit from typecode class 0x1; device-true 69 (III 65 would mis-address)
  { family: 'DELAY', paramId: 70, name: 'DELAY_GAIN2', displayLabel: 'Gain 2', unit: 'db' }, // unit from typecode class 0x1; device-true 70 (III 66 would mis-address)
  ...
  { family: 'DELAY', paramId: 73, name: 'DELAY_OFFSET', displayLabel: 'Right Post Delay', unit: 'ms' }, // unit from typecode class 0x4; device-true 73 (III 69 would mis-address)
  ...
  { family: 'DELAY', paramId: 76, name: 'DELAY_COMPTIME', displayLabel: 'Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 76 (III 72 would mis-address)
  { family: 'DELAY', paramId: 77, name: 'DELAY_COMPTHRESH', displayLabel: 'Threshold', unit: 'db' }, // unit from typecode class 0x1; device-true 77 (III 73 would mis-address)
  ...
  { family: 'DELAY', paramId: 79, name: 'DELAY_DIFFRATE', displayLabel: 'LFO Rate', unit: 'hz' }, // unit from typecode class 0x2; device-true 79 (III 75 would mis-address)
  { family: 'DELAY', paramId: 80, name: 'DELAY_DIFFDEPTH', displayLabel: 'LFO Depth', unit: 'percent' }, // unit from typecode class 0x5; device-true 80 (III 76 would mis-address)
  ...
  { family: 'DELAY', paramId: 82, name: 'DELAY_RATE4', displayLabel: 'Rate', unit: 'hz' }, // unit from typecode class 0x2; device-true 82 (III 78 would mis-address)
  ...
  { family: 'DELAY', paramId: 84, name: 'DELAY_DEPTH4', displayLabel: 'Depth', unit: 'percent' }, // unit from typecode class 0x5; device-true 84 (III 80 would mis-address)
  { family: 'DELAY', paramId: 85, name: 'DELAY_LFO4PHASE', displayLabel: 'Phase', unit: 'degrees' }, // unit from typecode class 0x6; device-true 85 (III 81 would mis-address)
  ...
  { family: 'DISTORT', paramId: 16, name: 'DISTORT_HPFREQ', displayLabel: 'Low Cut Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 16 (III 6 would mis-address)
  { family: 'DISTORT', paramId: 17, name: 'DISTORT_LPFREQ', displayLabel: 'High Cut Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 17 (III 7 would mis-address)
  { family: 'DISTORT', paramId: 18, name: 'DISTORT_TONEFREQ', displayLabel: 'Tonestack Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 18 (III 8 would mis-address)
  ...
  { family: 'DISTORT', paramId: 21, name: 'DISTORT_WSLPF', unit: 'hz' }, // device-true 21 (III 11 would mis-address) // unit from typecode class 0x2
  { family: 'DISTORT', paramId: 22, name: 'DISTORT_XFHPF', displayLabel: 'XFormer Low Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 22 (III 12 would mis-address)
  { family: 'DISTORT', paramId: 23, name: 'DISTORT_XFLPF', displayLabel: 'XFormer Hi Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 23 (III 13 would mis-address)
  ...
  { family: 'DISTORT', paramId: 33, name: 'DISTORT_SPKRLFREQ', displayLabel: 'Low Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 33 (III 26 would mis-address)
  ...
  { family: 'DISTORT', paramId: 37, name: 'DISTORT_MVCAP', displayLabel: 'Master Vol Cap', unit: 'pf' }, // unit from typecode class 0x8; device-true 37 (III 31 would mis-address)
  { family: 'DISTORT', paramId: 38, name: 'DISTORT_WSHPF', unit: 'hz' }, // device-true 38 (III 32 would mis-address) // unit from typecode class 0x2
  ...
  { family: 'DISTORT', paramId: 41, name: 'DISTORT_TIMECONST', displayLabel: 'B+ Time Constant', unit: 'ms' }, // unit from typecode class 0x4; device-true 41 (III 35 would mis-address)
  ...
  { family: 'DISTORT', paramId: 49, name: 'DISTORT_SPKRHFREQ', displayLabel: 'High Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 49 (III 43 would mis-address)
  ...
  { family: 'DISTORT', paramId: 69, name: 'DISTORT_BIASEXCURSION', displayLabel: 'Bias Excursion', unit: 'percent' }, // unit from typecode class 0x5; device-true 69 (III 63 would mis-address)
  { family: 'DISTORT', paramId: 70, name: 'DISTORT_EXCURSIONTIME', displayLabel: 'Excursion Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 70 (III 64 would mis-address)
  { family: 'DISTORT', paramId: 71, name: 'DISTORT_RECOVERYTIME', displayLabel: 'Recovery Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 71 (III 65 would mis-address)
  { family: 'DISTORT', paramId: 72, name: 'DISTORT_FEEDFWDFREQ2', displayLabel: 'Triode 2 Plate Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 72 (III 66 would mis-address)
  { family: 'DISTORT', paramId: 73, name: 'DISTORT_FEEDFWDFREQ1', displayLabel: 'Triode 1 Plate Freq', unit: 'hz' }, // unit from typecode class 0x2; device-true 73 (III 67 would mis-address)
  ...
  { family: 'DISTORT', paramId: 78, name: 'DISTORT_INEQFREQ', displayLabel: 'Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 78 (III 72 would mis-address)
  { family: 'DISTORT', paramId: 79, name: 'DISTORT_INEQGAIN', displayLabel: 'Gain', unit: 'db' }, // unit from typecode class 0x1; device-true 79 (III 73 would mis-address)
  ...
  { family: 'DISTORT', paramId: 81, name: 'DISTORT_COMPRESSION', displayLabel: 'Out Compression', unit: 'knob_0_10', displayMin: 0, displayMax: 10 }, // inferred from AM4; device-true 81 (III 75 would mis-address)
  ...
  { family: 'DISTORT', paramId: 86, name: 'DISTORT_CFTHRESH', displayLabel: 'Compression', unit: 'percent' }, // unit from typecode class 0x5; device-true 86 (III 80 would mis-address)
  ...
  { family: 'DISTORT', paramId: 93, name: 'DISTORT_LINEFREQ', displayLabel: 'AC Line Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 93 (III 87 would mis-address)
  ...
  { family: 'DISTORT', paramId: 99, name: 'DISTORT_CBRATIO', displayLabel: 'Cathode Resistance', unit: 'percent' }, // unit from typecode class 0x5; device-true 99 (III 93 would mis-address)
  { family: 'DISTORT', paramId: 100, name: 'DISTORT_CBTIME', displayLabel: 'Cathode Time Const', unit: 'ms' }, // unit from typecode class 0x4; device-true 100 (III 94 would mis-address)
  ...
  { family: 'DISTORT', paramId: 103, name: 'DISTORT_HITREBLE', displayLabel: 'High Treble', unit: 'db' }, // unit from typecode class 0x1; device-true 103 (III 97 would mis-address)
  ...
  { family: 'DISTORT', paramId: 112, name: 'DISTORT_TRIODE2RATIO', displayLabel: 'Preamp Bias Excursion', unit: 'percent' }, // unit from typecode class 0x5; device-true 112 (III 106 would mis-address)
  ...
  { family: 'DISTORT', paramId: 120, name: 'DISTORT_PIEXCURSION', displayLabel: 'PI Bias Excursion', unit: 'percent' }, // unit from typecode class 0x5; device-true 120 (III 114 would mis-address)
  ...
  { family: 'DISTORT', paramId: 122, name: 'DISTORT_MDTIME', displayLabel: 'Speaker Time Const', unit: 'ms' }, // unit from typecode class 0x4; device-true 122 (III 116 would mis-address)
  ...
  { family: 'DISTORT', paramId: 128, name: 'DISTORT_BOOSTLVL', displayLabel: 'Boost Level', unit: 'db' }, // unit from typecode class 0x1; device-true 128 (III 122 would mis-address)
  ...
  { family: 'DISTORT', paramId: 131, name: 'DISTORT_SPKRDYNAMICS', displayLabel: 'Speaker Compliance', unit: 'percent' }, // unit from typecode class 0x5; device-true 131 (III 125 would mis-address)
  ...
  { family: 'DISTORT', paramId: 135, name: 'DISTORT_CABRESONANCE', displayLabel: 'Cab Resonance', unit: 'percent' }, // unit from typecode class 0x5; device-true 135 (III 129 would mis-address)
  ...
  { family: 'DISTORT', paramId: 138, name: 'DISTORT_BIASX', displayLabel: 'Master Bias Excursion', unit: 'percent' }, // unit from typecode class 0x5; device-true 138 (III 132 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 50, name: 'GLOBAL_GATE_OFFSET', displayLabel: 'Noisegate Offset', unit: 'db' }, // unit from typecode class 0x1; device-true 50 (III 39 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 55, name: 'GLOBAL_IN1_TRIM', displayLabel: 'Input 1 / Instrument', unit: 'percent' }, // unit from typecode class 0x5; device-true 55 (III 44 would mis-address)
  { family: 'GLOBAL', paramId: 56, name: 'GLOBAL_IN2_TRIM', displayLabel: 'Input 2', unit: 'percent' }, // unit from typecode class 0x5; device-true 56 (III 45 would mis-address)
  { family: 'GLOBAL', paramId: 57, name: 'GLOBAL_IN3_TRIM', displayLabel: 'Input 3', unit: 'percent' }, // unit from typecode class 0x5; device-true 57 (III 46 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 124, name: 'GLOBAL_FC_RING_BRIGHT_LEVEL', displayLabel: 'Bright', unit: 'percent' }, // unit from typecode class 0x5; device-true 124 (III 110 would mis-address)
  { family: 'GLOBAL', paramId: 125, name: 'GLOBAL_FC_RING_DIM_LEVEL', displayLabel: 'Dim', unit: 'percent' }, // unit from typecode class 0x5; device-true 125 (III 111 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 133, name: 'GLOBAL_METLEVEL1', displayLabel: 'Output 1', unit: 'db' }, // unit from typecode class 0x1; device-true 133 (III 119 would mis-address)
  { family: 'GLOBAL', paramId: 134, name: 'GLOBAL_METLEVEL2', displayLabel: 'Output 2', unit: 'db' }, // unit from typecode class 0x1; device-true 134 (III 120 would mis-address)
  { family: 'GLOBAL', paramId: 135, name: 'GLOBAL_METLEVEL3', displayLabel: 'USB / Digital', unit: 'db' }, // unit from typecode class 0x1; device-true 135 (III 121 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 137, name: 'GLOBAL_USBLEVEL1', displayLabel: 'USB 1/2', unit: 'db' }, // unit from typecode class 0x1; device-true 137 (III 123 would mis-address)
  { family: 'GLOBAL', paramId: 138, name: 'GLOBAL_USBLEVEL2', displayLabel: 'USB 3/4', unit: 'db' }, // unit from typecode class 0x1; device-true 138 (III 124 would mis-address)
  { family: 'GLOBAL', paramId: 139, name: 'GLOBAL_USBLEVEL3', displayLabel: 'USB 5/6', unit: 'db' }, // unit from typecode class 0x1; device-true 139 (III 125 would mis-address)
  { family: 'GLOBAL', paramId: 140, name: 'GLOBAL_USBLEVEL4', displayLabel: 'USB 7/8', unit: 'db' }, // unit from typecode class 0x1; device-true 140 (III 126 would mis-address)
  { family: 'GLOBAL', paramId: 145, name: 'GLOBAL_AESLEVEL', displayLabel: 'SPDIF', unit: 'db' }, // unit from typecode class 0x1; device-true 145 (III 131 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 8664, name: 'GLOBAL_EQ1_FREQ1', displayLabel: 'Frequency 1', unit: 'hz' }, // unit from typecode class 0x2; device-true 8664 (III 8396 would mis-address)
  { family: 'GLOBAL', paramId: 8665, name: 'GLOBAL_EQ1_FREQ2', displayLabel: 'Frequency 2', unit: 'hz' }, // unit from typecode class 0x2; device-true 8665 (III 8397 would mis-address)
  { family: 'GLOBAL', paramId: 8666, name: 'GLOBAL_EQ1_FREQ3', displayLabel: 'Frequency 3', unit: 'hz' }, // unit from typecode class 0x2; device-true 8666 (III 8398 would mis-address)
  { family: 'GLOBAL', paramId: 8667, name: 'GLOBAL_EQ1_FREQ4', displayLabel: 'Frequency 4', unit: 'hz' }, // unit from typecode class 0x2; device-true 8667 (III 8399 would mis-address)
  { family: 'GLOBAL', paramId: 8668, name: 'GLOBAL_EQ1_FREQ5', displayLabel: 'Frequency 5', unit: 'hz' }, // unit from typecode class 0x2; device-true 8668 (III 8400 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 8674, name: 'GLOBAL_EQ1_GAIN1', displayLabel: 'Gain 1', unit: 'db' }, // unit from typecode class 0x1; device-true 8674 (III 8406 would mis-address)
  { family: 'GLOBAL', paramId: 8675, name: 'GLOBAL_EQ1_GAIN2', displayLabel: 'Gain 2', unit: 'db' }, // unit from typecode class 0x1; device-true 8675 (III 8407 would mis-address)
  { family: 'GLOBAL', paramId: 8676, name: 'GLOBAL_EQ1_GAIN3', displayLabel: 'Gain 3', unit: 'db' }, // unit from typecode class 0x1; device-true 8676 (III 8408 would mis-address)
  { family: 'GLOBAL', paramId: 8677, name: 'GLOBAL_EQ1_GAIN4', displayLabel: 'Gain 4', unit: 'db' }, // unit from typecode class 0x1; device-true 8677 (III 8409 would mis-address)
  { family: 'GLOBAL', paramId: 8678, name: 'GLOBAL_EQ1_GAIN5', displayLabel: 'Gain 5', unit: 'db' }, // unit from typecode class 0x1; device-true 8678 (III 8410 would mis-address)
  { family: 'GLOBAL', paramId: 8679, name: 'GLOBAL_EQ2_FREQ1', displayLabel: 'Frequency 1', unit: 'hz' }, // unit from typecode class 0x2; device-true 8679 (III 8411 would mis-address)
  { family: 'GLOBAL', paramId: 8680, name: 'GLOBAL_EQ2_FREQ2', displayLabel: 'Frequency 2', unit: 'hz' }, // unit from typecode class 0x2; device-true 8680 (III 8412 would mis-address)
  { family: 'GLOBAL', paramId: 8681, name: 'GLOBAL_EQ2_FREQ3', displayLabel: 'Frequency 3', unit: 'hz' }, // unit from typecode class 0x2; device-true 8681 (III 8413 would mis-address)
  { family: 'GLOBAL', paramId: 8682, name: 'GLOBAL_EQ2_FREQ4', displayLabel: 'Frequency 4', unit: 'hz' }, // unit from typecode class 0x2; device-true 8682 (III 8414 would mis-address)
  { family: 'GLOBAL', paramId: 8683, name: 'GLOBAL_EQ2_FREQ5', displayLabel: 'Frequency 5', unit: 'hz' }, // unit from typecode class 0x2; device-true 8683 (III 8415 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 8689, name: 'GLOBAL_EQ2_GAIN1', displayLabel: 'Gain 1', unit: 'db' }, // unit from typecode class 0x1; device-true 8689 (III 8421 would mis-address)
  { family: 'GLOBAL', paramId: 8690, name: 'GLOBAL_EQ2_GAIN2', displayLabel: 'Gain 2', unit: 'db' }, // unit from typecode class 0x1; device-true 8690 (III 8422 would mis-address)
  { family: 'GLOBAL', paramId: 8691, name: 'GLOBAL_EQ2_GAIN3', displayLabel: 'Gain 3', unit: 'db' }, // unit from typecode class 0x1; device-true 8691 (III 8423 would mis-address)
  { family: 'GLOBAL', paramId: 8692, name: 'GLOBAL_EQ2_GAIN4', displayLabel: 'Gain 4', unit: 'db' }, // unit from typecode class 0x1; device-true 8692 (III 8424 would mis-address)
  { family: 'GLOBAL', paramId: 8693, name: 'GLOBAL_EQ2_GAIN5', displayLabel: 'Gain 5', unit: 'db' }, // unit from typecode class 0x1; device-true 8693 (III 8425 would mis-address)
  { family: 'GLOBAL', paramId: 8694, name: 'GLOBAL_EQ3_FREQ1', displayLabel: 'Frequency 1', unit: 'hz' }, // unit from typecode class 0x2; device-true 8694 (III 8426 would mis-address)
  { family: 'GLOBAL', paramId: 8695, name: 'GLOBAL_EQ3_FREQ2', displayLabel: 'Frequency 2', unit: 'hz' }, // unit from typecode class 0x2; device-true 8695 (III 8427 would mis-address)
  { family: 'GLOBAL', paramId: 8696, name: 'GLOBAL_EQ3_FREQ3', displayLabel: 'Frequency 3', unit: 'hz' }, // unit from typecode class 0x2; device-true 8696 (III 8428 would mis-address)
  { family: 'GLOBAL', paramId: 8697, name: 'GLOBAL_EQ3_FREQ4', displayLabel: 'Frequency 4', unit: 'hz' }, // unit from typecode class 0x2; device-true 8697 (III 8429 would mis-address)
  { family: 'GLOBAL', paramId: 8698, name: 'GLOBAL_EQ3_FREQ5', displayLabel: 'Frequency 5', unit: 'hz' }, // unit from typecode class 0x2; device-true 8698 (III 8430 would mis-address)
  ...
  { family: 'GLOBAL', paramId: 8704, name: 'GLOBAL_EQ3_GAIN1', displayLabel: 'Gain 1', unit: 'db' }, // unit from typecode class 0x1; device-true 8704 (III 8436 would mis-address)
  { family: 'GLOBAL', paramId: 8705, name: 'GLOBAL_EQ3_GAIN2', displayLabel: 'Gain 2', unit: 'db' }, // unit from typecode class 0x1; device-true 8705 (III 8437 would mis-address)
  { family: 'GLOBAL', paramId: 8706, name: 'GLOBAL_EQ3_GAIN3', displayLabel: 'Gain 3', unit: 'db' }, // unit from typecode class 0x1; device-true 8706 (III 8438 would mis-address)
  { family: 'GLOBAL', paramId: 8707, name: 'GLOBAL_EQ3_GAIN4', displayLabel: 'Gain 4', unit: 'db' }, // unit from typecode class 0x1; device-true 8707 (III 8439 would mis-address)
  { family: 'GLOBAL', paramId: 8708, name: 'GLOBAL_EQ3_GAIN5', displayLabel: 'Gain 5', unit: 'db' }, // unit from typecode class 0x1; device-true 8708 (III 8440 would mis-address)
  ...
  { family: 'PLEX', paramId: 59, name: 'PLEX_SPLICE', displayLabel: 'Granule Length', unit: 'ms' }, // unit from typecode class 0x4
  ...
  { family: 'REVERB', paramId: 1, name: 'REVERB_LEVEL', displayLabel: 'Level', unit: 'db' }, // unit from typecode class 0x1; device-true 1 (III 14 would mis-address)
  ...
  { family: 'REVERB', paramId: 18, name: 'REVERB_REVERBLEVEL', displayLabel: 'Late Level', unit: 'db' }, // unit from typecode class 0x1; device-true 18 (III 8 would mis-address)
  ...
  { family: 'REVERB', paramId: 23, name: 'REVERB_GAIN', displayLabel: 'Input Gain', unit: 'percent' }, // unit from typecode class 0x5; device-true 23 (III 18 would mis-address)
  ...
  { family: 'REVERB', paramId: 25, name: 'REVERB_INPDIFF', displayLabel: 'Input Diffusion', unit: 'percent' }, // unit from typecode class 0x5; device-true 25 (III 20 would mis-address)
  { family: 'REVERB', paramId: 26, name: 'REVERB_INDIFFTIME', displayLabel: 'Input Diff Time', unit: 'percent' }, // unit from typecode class 0x5; device-true 26 (III 21 would mis-address)
  ...
  { family: 'REVERB', paramId: 38, name: 'REVERB_LFXOVER', displayLabel: 'Crossover Frequency', unit: 'hz' }, // unit from typecode class 0x2; device-true 38 (III 34 would mis-address)
  { family: 'REVERB', paramId: 39, name: 'REVERB_SPREAD', displayLabel: 'Spread', unit: 'percent' }, // unit from typecode class 0x5; device-true 39 (III 35 would mis-address)
  { family: 'REVERB', paramId: 40, name: 'REVERB_ATTEN', displayLabel: 'Attenuation', unit: 'db' }, // unit from typecode class 0x1; device-true 40 (III 36 would mis-address)
  ...
  { family: 'REVERB', paramId: 42, name: 'REVERB_RELEASE', displayLabel: 'Release Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 42 (III 38 would mis-address)
  ...
  { family: 'REVERB', paramId: 46, name: 'REVERB_EARLYSEND', displayLabel: 'Late Input Mix', unit: 'percent' }, // unit from typecode class 0x5; device-true 46 (III 42 would mis-address)
  ...
  { family: 'REVERB', paramId: 52, name: 'REVERB_DISPERSION', displayLabel: 'Boiiinnng!', unit: 'percent' }, // unit from typecode class 0x5; device-true 52 (III 48 would mis-address)
  ...
  { family: 'REVERB', paramId: 58, name: 'REVERB_PITCHFDBK', displayLabel: 'Feedback', unit: 'percent' }, // unit from typecode class 0x5; device-true 58 (III 54 would mis-address)
  ...
  { family: 'REVERB', paramId: 60, name: 'REVERB_PITCHTIME', displayLabel: 'Splice Time', unit: 'ms' }, // unit from typecode class 0x4; device-true 60 (III 56 would mis-address)
  ...
  { family: 'REVERB', paramId: 62, name: 'REVERB_PITCHMOD', displayLabel: 'Modulation', unit: 'percent' }, // unit from typecode class 0x5; device-true 62 (III 58 would mis-address)
  { family: 'REVERB', paramId: 63, name: 'REVERB_PITCHBAL', displayLabel: 'Voice Balance', unit: 'percent' }, // unit from typecode class 0x5; device-true 63 (III 59 would mis-address)
  ...
  { family: 'REVERB', paramId: 65, name: 'REVERB_PREDLYFDBK', displayLabel: 'Feedback', unit: 'percent' }, // unit from typecode class 0x5; device-true 65 (III 62 would mis-address)
  { family: 'REVERB', paramId: 66, name: 'REVERB_PREDLYMIX', displayLabel: 'Echo Mix', unit: 'percent' }, // unit from typecode class 0x5; device-true 66 (III 63 would mis-address)
  { family: 'REVERB', paramId: 67, name: 'REVERB_PITCHLPF', displayLabel: 'Pitch High Cut', unit: 'hz' }, // unit from typecode class 0x2; device-true 67 (III 64 would mis-address)
